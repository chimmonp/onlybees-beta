    ...
    return (
        <div className="h-[100svh] flex flex-col items-center justify-center text-black bg-black md:px-0 px-10 py-10">
            ...
            <div className=" md:w-[30svw] w-full bg-white py-10 px-10">
                <p className='text-[0.6rem] text-center text-[#de0a26]'>You have to <b>redeem your online tickets</b> for physical tickets from the redemption centre at<br /><LocationOnIcon sx={{ "fontSize": "1rem" }} /><b>Golf Club Parking Lot</b></p>
