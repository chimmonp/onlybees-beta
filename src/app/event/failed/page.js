...
const Failed = () => {
    ...
    return (
        <div className="h-[100svh] flex flex-col items-center justify-center text-black md:px-0 px-10 py-10">
            <div className="md:py-10 py-15 pt-10 md:pt-5 px-10 md:w-[30svw] w-full bg-white rounded-t-3xl relative text-center shadow-2xl">
                ...
                <h2 className='my-5 md:text-md text-[0.8rem]'>There was a problem processing your payment.</h2>
            ...
            <div className="md:w-[30svw] w-full bg-[#D9D9D9] rounded-b-3xl py-7 md:px-12 px-5 md:text-[0.8rem] text-[0.7rem] text-center md:leading-6">
                <Link href={`/durand-cup/tickets/aug-02`} className='bg-black text-white px-5 py-3 rounded-full'>Try Again</Link>
            </div>
        </div>
    );
}
