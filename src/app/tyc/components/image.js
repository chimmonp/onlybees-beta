...
const ImageComponent = () => {
  ...
  const makePayment = async () => {
    ...
    const orderPayload = {
      ...
      section: '66d7f8d392d7e78c2d00273c',
      ...
      <div className='w-full max-w-5xl mt-10'>
        ...
        >
          <span className="relative inline-block">
            <button className="relative z-10 text-base sm:text-lg md:text-xl font-medium underline cursor-none">BAR SECTION</button>
          </span>
        ...
        >
          ...
          >
            ...
            <option value="R1">B1</option>
            <option value="R2">B2</option>
            <option value="R3">B3</option>
            <option value="R4">B4</option>
            <option value="R5">B5</option>
            <option value="R6">B6</option>
            <option value="R7">B7</option>
            <option value="R8">B8</option>
            <option value="R9">B9</option>
            <option value="R10">PDR</option>
          </select>
        </motion.div>
